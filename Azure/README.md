...
- [Function Apps - how to use SQL update query in azure functions SQL output binding in python](https://www.sqlshack.com/python-serverless-functions-to-query-azure-sql-db/)
